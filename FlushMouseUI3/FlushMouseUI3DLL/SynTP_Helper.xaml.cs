			...
			if (sender != null) {
				switch (dwSynTPHelper1) {
					case SYNTPH_DISABLE:
						...
						rb4?.IsEnabled = false;	rb5?.IsEnabled = false;

						tb1?.IsEnabled = false;	tb2?.IsEnabled = false;	tb3?.IsEnabled = false;
						tb4?.IsEnabled = false;	tb5_1?.IsEnabled = false;	tb5_2?.IsEnabled = false;
						tb5_3?.IsEnabled = false;	tb5_4?.IsEnabled = false;	tb6?.IsEnabled = false;
						tb7?.IsEnabled = false;
					...
					case SYNTPH_SENDERHOSNAMEIPV4_START:
						...
						tb1?.IsEnabled = true;	tb2?.IsEnabled = true;
						tb3?.IsEnabled = true;	tb4?.IsEnabled = true;
						tb7?.IsEnabled = true;	
						if ((dwSynTPHelper1 == SYNTPH_SENDERIPV4) || (dwSynTPHelper1 == SYNTPH_SENDERIPV4_START)) {
							tb5_1?.IsEnabled = true;	tb5_2?.IsEnabled = true;
							tb5_3?.IsEnabled = true;	tb5_4?.IsEnabled = true;
							tb6?.IsEnabled = false;
						}
						else if ((dwSynTPHelper1 == SYNTPH_SENDERHOSNAMEIPV4) || (dwSynTPHelper1 == SYNTPH_SENDERHOSNAMEIPV4_START)) {
							tb5_1?.IsEnabled = false;	tb5_2?.IsEnabled = false;
							tb5_3?.IsEnabled = false;	tb5_4?.IsEnabled = false;
							tb6?.IsEnabled = true;
						}
						cb1?.IsEnabled = true;
					...
					case SYNTPH_RECEIVERIPV4_START:
						...
						cb1?.IsEnabled = true;	cb1?.IsEnabled = true;
				...
				if (bSynTPStarted1) {
					rb1?.IsEnabled = false;	rb2?.IsEnabled = false;	rb3?.IsEnabled = false;
					rb4?.IsEnabled = false;	rb5?.IsEnabled = false;
