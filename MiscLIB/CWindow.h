...
void	vInvalidateWindowCache(_In_z_ const LPCTSTR lpszClassName);
void	vInvalidateWindowExCache(_In_opt_ HWND hWndParent, _In_z_ const LPCTSTR lpszClassName);
...
class CWindow
{
	...
	public:
		...
		BOOL		bInvalidateRect(_In_opt_ LPCRECT lpRect, _In_ BOOL bErase) const;
		BOOL		bSetWndThreadPriority(_In_ int nPriority) const;
