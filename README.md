...
#### (今後について)
   ...
   * ご要望や、バグ等については、X (Twitter)[@JeffyTSonTW] のタイムライン、または DM にお願いします
   * また、会社、団体等で使用したい場合は、コードレビューやカスタマイズも可能です。その場合は有償 (単価(内容によります。話し合いで決めさせていただきます) x 時間 + 交通費等の諸経費 )になります。X (Twitter)[@JeffyTSonTW] の DM にてご相談ください
