...
* **2024/12/12　　Version 3.4.8.15 を リリースしました**

* **(主な変更点)**
   * 設定画面の色がおかしくなる場合があるのを修正しました
   * 前回のバージョンでタスクトレイへの登録に GUIDを使用するようにしましたが、いろいろと不便なので uIDに戻しました
   * 動作の調整を行いました
   * 簡単な Demo をGitHub のページに掲載しました
