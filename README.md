...
* **2025/06/02　　Version 3.5.5.5 を リリースしました**

* **(主な変更点)**
   * 無変換を押した時の、IMEモードを表示するタイミングを変更しました
   * 当方の事情で、Double Code Signing がうまくできないため、当面見送ることにしました
   * Windowsのフォントが変更になったようです。設定でお好みになるよう調整してみてください
   * Windows 11 24H2 での動作を実機で確認しました
