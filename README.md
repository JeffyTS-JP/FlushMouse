...
* **2024/07/14　　Version 2.2.6.1 をリリースしました**

* **(主な変更点)**
   * Windows の msvcp140.dll のバージョンが古いときに、FlushMouseUI3 がエラーで起動しない現象に対応しました
   * 緊急リリースのため、以下に Version 2.2.5.8 のリリース情報を残しておきます
