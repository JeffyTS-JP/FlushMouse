...
* **2024/11/26　　Version 3.4.5.21 を リリースしました**

* **(主な変更点)**
   * 直接描画方式と、リソースと併用の場合、特殊なケースで描画が不正に残ってしまうのを修正しました
...
* **(既知の問題)**
   * MSVCP140.dll が古くて動かない場合があるようです。その場合には Microsoft社の[こちら](https://aka.ms/vs/17/release/vc_redist.x64.exe)からダウンロードしてインストールしてください。こちらで最良付するようにするかは今後検討します
